...
public class MoveCardLocations {
    ...
    public static final float ENEMY_CHEMICAL_LOCATION_Y = ALL_CHEMICAL_BOTTOM + ((ALL_CHEMICAL_TOP - ALL_CHEMICAL_BOTTOM) * (2f/3f));
    public static final float FREE_CHEMICAL_LOCATION_Y = ALL_CHEMICAL_BOTTOM + ((ALL_CHEMICAL_TOP - ALL_CHEMICAL_BOTTOM) * (1f/3f));
    public static final float PLAYER_CHEMICAL_LOCATION_Y = ALL_CHEMICAL_BOTTOM;
    public static final float CHEMICAL_LABEL_HEIGHT = 22f;
